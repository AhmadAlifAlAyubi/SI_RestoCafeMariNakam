                    ...
                    <div class="row">
                        <div class="col-md-4 pr-1">
                            <div class="form-group">
                                ...
                                <input type="text" name="Nama_Cafe" class="form-control" placeholder="Nama"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="Alamat_Cafe" class="form-control" placeholder="alamat"
                                    value="{{ $cafe->Alamat_Cafe }}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4 pr-1">
                            <div class="form-group">
                                ...
                                <input type="text" name="Rating_Cafe" class="form-control" placeholder="Rating"
                                    value="{{ $cafe->Rating_Cafe }}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
