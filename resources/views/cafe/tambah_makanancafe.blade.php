...
<div class="col-md-8">
    <div class="card card-user">
        ...
        <div class="card-body">
            <form action="/makanancafeInsert" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="ID_Makanan" class="form-control" placeholder="ID" value="">
                        </div>
                    </div>
                    <div class="col-md-6 ">
                        <div class="form-group">
                            <label>Nama Makanan</label>
                            <input type="text" name="Nama_Makanan" class="form-control" placeholder="Nama" value="">
                        </div>
                    </div>
                ...
                <div class="col-md-4 px-0">
                    <div class="form-group">
                        <label>Harga</label>
                        <input type="text" name="Harga_Makanan" class="form-control" placeholder="Harga" value="">
                    </div>
                </div>
        </div>
        <div class="row">
