...
@section('konten')
    <div class="col-md-8">
        <div class="card card-user">
            ...
            <div class="card-body">
                <form action="/minumancafeUpdate/{{ $minumancafe->ID_Minuman }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-6 ">
                            <div class="form-group">
                                ...
                                <input type="text" name="Nama_Minuman" class="form-control" placeholder="Nama"
                                    value="{{ $minumancafe->Nama_Minuman }}">
                            </div>
                        </div>
                    ...
                    <div class="col-md-4 px-0">
                        <div class="form-group">
                            ...
                            <input type="text" name="Harga_Minuman" class="form-control" placeholder="Harga"
                                value="{{ $minumancafe->Harga_Minuman }}">
                        </div>
                    </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group px-3">
                        ...
                        <textarea class="form-control textarea" name="Deskripsi_Minuman" placeholder="Deskripsi"
                            value="{{ $minumancafe->Deskripsi_Minuman }}"></textarea>
                    </div>
                </div>
            </div>
            <div class="row">
