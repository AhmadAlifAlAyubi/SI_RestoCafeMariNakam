...
<div class="col-md-8">
  <div class="card card-user">
      ...
      <div class="card-body">
        <form action="kriteriacafeInsert" method="POST" enctype="multipart/form-data">
            @csrf
              <div class="row">
              ...
              <div class="row">
                  <div class="col-md-4 pr-1">
                      <div class="form-group">
                          ...
                          <input type="text" name="Nama_Kriteria_Cafe" class="form-control" placeholder="Nama" value="">
                      </div>
                  </div>
              </div>
              <div class="row">
