...
@section('konten')
    <div class="col-md-8">
        <div class="card card-user">
            ...
            <div class="card-body">
                <form action="/pembeliUpdate/{{ $pembeli->ID_Pelanggan }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="Alamat_Pelanggan" class="form-control" placeholder="alamat"
                                    value="{{ $pembeli->Alamat_Pelanggan }}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
