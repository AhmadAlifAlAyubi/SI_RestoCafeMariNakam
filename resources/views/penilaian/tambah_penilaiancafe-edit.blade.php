...
@section('konten')
    <div class="col-md-8">
        <div class="card card-user">
            ...
            <div class="card-body">
                <form action="/penilaiancafeUpdate/{{ $penilaiancafe->ID_Penilaian_Cafe }}" method="POST"
                        ...
                        <div class="col-md-4 pr-1">
                            <div class="form-group">
                                ...
                                <input type="text" name="ID_Penilaian_Cafe" class="form-control" placeholder="ID"
                                    value="{{ $penilaiancafe->ID_Penilaian_Cafe }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 pr1">
                            <div class="form-group">
                                ...
                                <input type="text" name="Nilai_Penilaian_Cafe" class="form-control" placeholder="Nilai"
                                    value="{{ $penilaiancafe->Nilai_Penilaian_Cafe }}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
