...
@section('konten')
    <div class="col-md-8">
        <div class="card card-user">
            ...
            <div class="card-body">
                <form action="/penilaianrestoUpdate/{{ $penilaianresto->ID_Penilaian_Restoran }}" method="POST"
                        ...
                        <div class="col-md-4 pr-1">
                            <div class="form-group">
                                ...
                                <input type="text" name="ID_Penilaian_Restoran" class="form-control" placeholder="ID"
                                    value="{{ $penilaianresto->ID_Penilaian_Restoran }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 pr1">
                            <div class="form-group">
                                ...
                                <input type="text" name="Nilai_Penilaian_Restoran" class="form-control"
                                    placeholder="Nilai" value="{{ $penilaianresto->Nilai_Penilaian_Restoran }}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
